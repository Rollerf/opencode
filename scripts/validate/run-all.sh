...
"${ROOT_DIR}/scripts/validate/token-savings-defaults-contract.sh"
"${ROOT_DIR}/scripts/validate/gitflow-branching-contract.sh"
"${ROOT_DIR}/scripts/validate/tdd-contract.sh"
"${ROOT_DIR}/scripts/validate/task-refinement-contract.sh"
"${ROOT_DIR}/scripts/validate/model-cost-contract.sh"
"${ROOT_DIR}/scripts/validate/angular-ui-contract.sh"
"${ROOT_DIR}/scripts/validate/astro-pack-contract.sh"
