...
- Keep only documentation, design-document, Pulumi, and TDD subagents. Assign `openai/gpt-6-sol` to the orchestrator and high-risk specialists, and `openai/gpt-5.6-luna` to bounded documentation and design helpers. Remove the feature-iteration subagent and absorb feature iteration into the implementation phase skill.
